  ...
  console.log(`narrative.create_gui()`);
    ...
    var euclidean_c,
        ...
        options = {
          ...
          euclidean_cube: 'side=2 at (0, 1, -10) red';
          hyperbolic_cube: 'side=2 at (0, -1, -10) green';
          ...
          reset_to_initial: function() {
            ...
            options['positionZ'] = -10.0;
            x = 0.0;
            y = 0.0;
            z = -10.0;
            camera.lookAt(0,0,0);  // origin
            e_cube.position.set(0, 1, -10);
            e_cube.visible = true;
            options['euclidean'] = true;
            h_cube.position.set(0, -1, -10);
            h_cube.visible = true;
    ...
    z_c = datgui.add(options, 'positionZ', -100,7).listen();
